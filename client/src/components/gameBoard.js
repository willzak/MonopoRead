  ...
  return (
    <div className="game-board">
      ...
      <div className="bottom-row">
        ...
        <Chance drawChance={props.drawChance} pos={15} id="Chance1" players={props.players} direction="top" chance={props.chance} />
      ...
      <div className="column-organiser">
        <div>
          ...
          <Chance drawChance={props.drawChance} pos={9} id="Chance2" players={props.players} direction="left" chance={props.chance} />
        ...
        <Console tiles={props.tiles} chance={props.chance} />
        <div>
          ...
          <Chance drawChance={props.drawChance} pos={21} id="Chance3" players={props.players} direction="right" chance={props.chance} />
      ...
      <div className="bottom-row">
        ...
        <Chance drawChance={props.drawChance} pos={3} id="Chance4" players={props.players} direction="bottom" chance={props.chance} />
