  ...
  return (
    <section className="game-view">
      ...
      <div className="side-console">
        <SideBar game={props.game} endBoard={props.endBoard} currentPlayer={props.currentPlayer} rollDice={props.rollDice} chance={props.chance} players={props.players} board={props.board} />
      </div>
      {props.showReview &&
